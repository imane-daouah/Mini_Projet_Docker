pipeline {
    ...
    environment {
        DOCKER_IMAGE_FRONTEND = 'imane/frontend:1.0'
        DOCKER_IMAGE_BACKEND = 'imane/backend:1.0'
    ...
    stages {
        stage('Cloner le Dépôt') {
            steps {
                git branch: 'main', url: 'https://github.com/imane-daouah/Mini_Projet_Docker.git'
            }
        }
